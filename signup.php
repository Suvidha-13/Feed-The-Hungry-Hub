        ...
        <div class="container">
            <div class="regform">
                ...
                <form action=" " method="post">
                    <p class="logo"><b style="color: #062bc1;"> Feed </b> The <b style="color: #4565e6;"> Hungry </b>
                        Hub </p>
                ...
                <input type="password" id="password" name="password" > -->
                 ...
                 Continue With  Google </button>  -->
                    ...
                    <div class="signin-up">
                        <p style="font-size: 20px; text-align: center;">Already have an account? <a href="signin.php">
                                Sign in</a></p>
                    </div>
